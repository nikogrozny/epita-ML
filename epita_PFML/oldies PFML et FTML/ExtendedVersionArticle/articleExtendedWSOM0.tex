...
\author{Nicolas Bourgeois\inst{1}
\and Marie Cottrell\inst{1} \and Benjamin D\'eruelle\inst{2} 
\and St\'ephane Lamass\'e\inst{2} \and Patrick Letr\'emy\inst{1}}

\institute{SAMM - Universit\'e Paris 1 Panth\'eon-Sorbonne\\
90, rue de Tolbiac, 75013 Paris, France\\
\mailENS\\
\mailSAMM \and
PIREH-LAMOP - Universit\'e Paris 1 Panth\'eon-Sorbonne\\
...
\node (abaisser) at (50.375,17.7){};
\node (calculer) at (27.925,45.7){};
\node (cercle) at (59.175,40.275){};

\begin{scope}[every node/.style={font={\footnotesize}}]
\draw[black,<-,line width=0.2mm] (abaisser) -- +(4,1)node[right]{abaisser};
\draw[black,<-,line width=0.2mm] (calculer) -- +(-4,-2)node[left]{calculer};
\draw[black,<-,line width=0.2mm] (cercle) -- +(4,0)node[right]{cercle};
\end{scope}
...
\node (abaisser) at (5.575,33.55){};
\node (calculer) at (52.6,8.8){};
\node (cercle) at (36.65,17.5){};

\begin{scope}[every node/.style={font={\footnotesize}}]
\draw[black,<-,line width=0.2mm] (abaisser) -- +(0,4)node[above]{abaisser};
...
\subsection{An example of use of Kohonen maps}
...
\hline
arithmetique {compter} preuve tenir & cubbement destre digit diviser diviseur division lignes nombre compo{se}querir & {dire} {figurer} poser {science} & & & abreger lever precedent quotiens & numerateur & moindre nombre \cellcolor{grisclair} \textbf{Nicolas Chuquet} & partir plus {raison} & \\
\hline
...
\caption{Example of Kohonen Map. Texts are in Bold and their cells are colored.}
\end{table}
